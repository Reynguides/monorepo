 ...
 * character proxy for a token budget — we use a chars≈token/4 framing in the KB
 * worker (ADR-0021), so a char cap here is a deterministic, tokenizer-free
 * stand-in for "how much context fits".
 *
